    ...
    public class Banner : Panel
    {
        ...
        protected override void  OnInit(EventArgs e)
        {
            base.OnInit(e);
                ...
                this.Page.ClientScript.RegisterClientScriptInclude("ajaxticker", this.Page.ClientScript.GetWebResourceUrl(typeof(Banner),
               "Signature.Web.Controls.css.ajaxticker.js"));
                Build();
        }
        protected virtual void Build()
        {
            this.Controls.Add(new LiteralControl(@"<table width='100%' height='100px' border='0'  align='center' cellpadding='0' cellspacing='0'>
 	<tr>	
		<td>"));
            /*
