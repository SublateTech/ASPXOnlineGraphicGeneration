...
ajax_ticker.prototype.initialize=function(){ 
	...
	for (var i=0; i<this.contentdiv.getElementsByTagName("div").length; i++){
		...
		//	alert(this.contentdiv.getElementsByTagName("div")[i].innerHTML );
			}
	}
...
function AddTicker(file)
	{
			
			//var xmlfile=http+window.location.hostname+"/cbbanner.php";  //path to ticker txt file on your server.
			//ajax_ticker(xmlfile, divId, divClass, delay, optionalfadeornot)

			var xmlfile=file; //"cbbanner.aspx";  //path to ticker txt file on your server.
